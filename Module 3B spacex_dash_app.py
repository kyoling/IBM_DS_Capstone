...
allsites = spacex_df['Launch Site'].unique().tolist()
options = []
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site_dropdown',options=options,placeholder='Select a Launch Site here', searchable = True , value = 'All Sites'),
                                html.Br(),
